...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-orange-600 via-yellow-400 to-orange-500 text-white py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <h1 className="text-6xl font-black mb-6 text-white">🏁 FORMULA 1 🏁</h1>
